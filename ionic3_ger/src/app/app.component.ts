...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'CadastroMomento' , component: CadastroMomentoPage},
	
      { title: 'GraficoLinha' , component: GraficoLinhaPage},
	
      { title: 'MediasSemanais' , component: MediasSemanaisPage},
	
      { title: 'MelhoresMomentosPorDimensao' , component: MelhoresMomentosPorDimensaoPage},
	
      { title: 'ConfiguracaoPeriodo' , component: ConfiguracaoPeriodoPage},
